...
public class SiteAdmin extends BaseUIBean {
    ...
    public void init() {
		...
		System.out.println("current user is " + service.getCurrentUser());
    ...
    public String viewDatasheetCat1() {
    	return "viewDatasheet_Country";
    }
    
    public String viewDatasheetCat2() {
    	return "viewDatasheet_State";
    }
    
    public String viewDatasheetCat3() {
    	return "viewDatasheet_Technology";
    }
    
    public String viewDatasheetCat4() {
    	return "viewDatasheet_Entity";
    }
