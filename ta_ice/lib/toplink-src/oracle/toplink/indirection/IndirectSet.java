 ...
 * </ul>
 *
 * @see oracle.toplink.mappings.CollectionMapping
 * @author Big Country
...
public class IndirectSet implements CollectionChangeTracker, Set, IndirectCollection, Cloneable, Serializable {
    ...
    */
    ...
    public boolean hasBeenRegistered() {
        return getValueHolder() instanceof oracle.toplink.internal.indirection.UnitOfWorkQueryValueHolder;
    }
    ...
    public String toString() {
        ...
        if (this.isInstantiated()) {
            ...
            return "{" + oracle.toplink.internal.helper.Helper.getShortClassName(this.getClass()) + ": " + ToStringLocalization.buildMessage("not_instantiated", (Object[])null) + "}";
