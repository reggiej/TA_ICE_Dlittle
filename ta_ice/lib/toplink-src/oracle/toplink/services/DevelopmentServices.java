...
public class DevelopmentServices {
    ...
    public void setIdentityMapForClass(String className, String identityMapClassType, int maxSize) throws ClassNotFoundException {
        ...
        oracle.toplink.descriptors.ClassDescriptor descriptor = getSession().getDescriptor(classToChange);
    ...
    public void refreshProject(String projectFilePath) {
        ...
        getSession().setProject(oracle.toplink.tools.workbench.XMLProjectReader.read(projectFilePath));
     ...
     */
    public void initializeCacheSynchronizationServices() throws oracle.toplink.exceptions.SynchronizationException {
