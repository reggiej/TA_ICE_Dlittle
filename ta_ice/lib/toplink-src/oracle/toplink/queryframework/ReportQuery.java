...
public class ReportQuery extends ReadAllQuery {
    ...
    public ReportQuery() {
        ...
        this.items = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance();
        this.shouldRetrievePrimaryKeys = NO_PRIMARY_KEY;
        this.groupByExpressions = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(3);
     ...
     * @see #addCount(java.lang.String, oracle.toplink.expressions.Expression)
     */
    ...
    public Vector getNames() {
        if (names == null) {
            names = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance();
