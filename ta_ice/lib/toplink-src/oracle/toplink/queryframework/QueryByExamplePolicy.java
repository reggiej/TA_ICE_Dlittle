...
public class QueryByExamplePolicy implements java.io.Serializable {
     ...
     * <p>
     * Any comparison operation in {@link oracle.toplink.expressions.Expression Expression} which takes the example attribute as a parameter
     ...
     * options are {@link oracle.toplink.expressions.Expression#isNull(Object) isNull} (default) and
     * {@link oracle.toplink.expressions.Expression#notNull(Object) notNull}.  See
     ...
     * @see oracle.toplink.expressions.Expression#equal equal (default)
     * @see oracle.toplink.expressions.Expression#notEqual notEqual
     * @see oracle.toplink.expressions.Expression#equalsIgnoreCase equalsIgnoreCase
     * @see oracle.toplink.expressions.Expression#lessThan lessThan
     * @see oracle.toplink.expressions.Expression#lessThanEqual lessThanEqual
     * @see oracle.toplink.expressions.Expression#greaterThan greaterThan
     * @see oracle.toplink.expressions.Expression#greaterThanEqual greaterThanEqual
     * @see oracle.toplink.expressions.Expression#like like
     * @see oracle.toplink.expressions.Expression#likeIgnoreCase likeIgnoreCase
     * @see oracle.toplink.expressions.Expression#containsAllKeyWords containsAllKeyWords
     * @see oracle.toplink.expressions.Expression#containsAnyKeyWords containsAnyKeyWords
     * @see oracle.toplink.expressions.Expression#containsSubstring(java.lang.String) containsSubstring
     * @see oracle.toplink.expressions.Expression#containsSubstringIgnoringCase(java.lang.String) containsSubstringIgnoringCase
     */
