...
public class PackageRenamer {
    ...
    */
    ...
    public static void usage() {
        ...
        System.out.println("");
        System.out.println("java oracle.toplink.tools.PackageRenamer <properties-file>");
        System.out.println("");
        System.out.println("OR");
        System.out.println("");
        System.out.println("java oracle.toplink.tools.PackageRenamer <properties-file> <source-root-directory> <destination-root-directory> [ <log-file> ]");
        System.out.println("");
