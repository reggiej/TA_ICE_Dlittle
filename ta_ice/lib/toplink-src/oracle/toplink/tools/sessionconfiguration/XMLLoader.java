...
import oracle.toplink.remote.jms.*;
...
public class XMLLoader {
    ...
    public XMLLoader(String resourceName) {
        ...
        m_entityResolver = new TopLinkEntityResolver();
    }
    ...
    public void load(final SessionManager sessionManager, final ClassLoader loader, final boolean shouldLoginSession, final boolean shouldRefreshSession) throws TopLinkException {
     ...
     * or not.
     */
    public void loadInternal(SessionManager sessionManager, ClassLoader loader, boolean shouldLoginSession, boolean shouldRefreshSession) throws TopLinkException {
    ...
    public void process_session_type_Tag(Node node, ObjectHolder projectHolder) {
        ...
        //is specified, this will be changed to oracle.toplink.internal.platform.server.ServerPlatform
    ...
    public void process_clustering_service_Tag(Node node, ObjectHolder sessionHolder) {
        try {
            ...
            Class[] params = { oracle.toplink.sessions.Session.class };
    ...
    public void process_platform_class_Tag(Node node, ObjectHolder loginHolder) {
        try {
            ...
            if ("oracle.toplink.internal.databaseaccess.AccessPlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.AccessPlatform";
            }else if ("oracle.toplink.internal.databaseaccess.AttunityPlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.AttunityPlatform";
            }else if ("oracle.toplink.internal.databaseaccess.CloudscapePlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.CloudscapePlatform";
            }else if ("oracle.toplink.internal.databaseaccess.DatabasePlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.DatabasePlatform";
            }else if ("oracle.toplink.internal.databaseaccess.DB2MainframePlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.DB2MainframePlatform";
            }else if ("oracle.toplink.internal.databaseaccess.DB2Platform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.DB2Platform";
            }else if ("oracle.toplink.internal.databaseaccess.DBasePlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.DBasePlatform";
            }else if ("oracle.toplink.internal.databaseaccess.HSQLPlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.HSQLPlatform";
            }else if ("oracle.toplink.internal.databaseaccess.InformixPlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.InformixPlatform";
            }else if ("oracle.toplink.internal.databaseaccess.OraclePlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.oracle.OraclePlatform";
            }else if ("oracle.toplink.internal.databaseaccess.PointBasePlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.PointBasePlatform";
            }else if ("oracle.toplink.internal.databaseaccess.SQLAnyWherePlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.SQLAnyWherePlatform";
            }else if ("oracle.toplink.internal.databaseaccess.SQLServerPlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.SQLServerPlatform";
            }else if ("oracle.toplink.internal.databaseaccess.SybasePlatform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.SybasePlatform";
            }else if ("oracle.toplink.oraclespecific.Oracle8Platform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.oracle.Oracle8Platform";
            }else if ("oracle.toplink.oraclespecific.Oracle9Platform".equals(nodeValue)){
                nodeValue = "oracle.toplink.platform.database.oracle.Oracle9Platform";
            }
            ...
            if (logType.equals("toplink")) {
                ...
                if (!Version.isJDK13()) {
                    try {
                        ...
                        defaultLog = (SessionLog)((Class)ConversionManager.getDefaultManager().convertObject("oracle.toplink.logging.JavaLog", Class.class)).newInstance();
