...
/**
 * <b>Purpose</b>: To generate StoredProcedures from TopLink Projects <p>
...
public class StoredProcedureGenerator {
    ...
    protected void buildIntToTypeConverterHash() {
        ...
        this.intToTypeConverterHash.put(new Integer(2), java.math.BigDecimal.class);
        ...
        this.intToTypeConverterHash.put(new Integer(91), java.sql.Date.class);
        this.intToTypeConverterHash.put(new Integer(93), java.sql.Timestamp.class);
        this.intToTypeConverterHash.put(new Integer(3), java.math.BigDecimal.class);

        this.intToTypeConverterHash.put(new Integer(-5), java.math.BigDecimal.class);
        ...
        //this.intToTypeConverterHash.put(new Integer(0),null.class);
    }
    ...
    public void generateAmendmentClass(Writer outputWriter, String packageName, String className) throws ValidationException {
        ...
        try {
            ...
            outputWriter.write("\n\t\t\tMethod method = " + className + ".class.getMethod(\"amend\"+oracle.toplink.internal.helper.Helper.getShortClassName(descriptor.getJavaClass())+\"ClassDescriptor\", new Class[] {ClassDescriptor.class});");
     ...
     */
    protected void generateSequenceStoredProcedures(oracle.toplink.sessions.Project project) {
     ...
     */
    protected void verify() throws oracle.toplink.exceptions.ValidationException {
        if (getSession().getProject().usesOptimisticLocking()) {
            throw oracle.toplink.exceptions.ValidationException.optimisticLockingNotSupportedWithStoredProcedureGeneration();
        }
    }
