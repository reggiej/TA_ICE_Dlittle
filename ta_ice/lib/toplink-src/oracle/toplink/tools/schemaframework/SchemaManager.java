...
public class SchemaManager {
    ...
    public SchemaManager(oracle.toplink.sessions.DatabaseSession session) {
     ...
     */
    protected void createOrReplaceSequences(boolean createSequenceTables, boolean createSequenceObjects) throws TopLinkException {
     ...
     * @throws TopLinkException
     */
    private void processDatabaseObjectDefinition(DatabaseObjectDefinition definition, final boolean create, final boolean shouldLogExceptionStackTrace){
     ...
     * or to a file.
     */
    public void generateStoredProceduresAndAmendmentClass(Writer writer, String fullyQualifiedClassName) throws TopLinkException {
     ...
     * or to a file.
     */
    public void generateStoredProceduresAndAmendmentClass(String path, String fullyQualifiedClassName) throws TopLinkException {
        try {
            StoredProcedureGenerator storedProcedureGenerator = new StoredProcedureGenerator(this);
    ...
    */
     ...
     * Drop and recreate the default table schema for the TopLink project this session associated with.
     */
    public void replaceDefaultTables(boolean keepSequenceTables, boolean generateFKConstraints) throws TopLinkException {
        boolean shouldLogExceptionStackTrace = getSession().getSessionLog().shouldLogExceptionStackTrace();
        getSession().getSessionLog().setShouldLogExceptionStackTrace(false);
