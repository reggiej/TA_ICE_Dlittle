...
import oracle.toplink.eis.mappings.EISCompositeCollectionMapping;
import oracle.toplink.eis.mappings.EISCompositeDirectCollectionMapping;
import oracle.toplink.eis.mappings.EISCompositeObjectMapping;
import oracle.toplink.eis.mappings.EISDirectMapping;
import oracle.toplink.eis.mappings.EISOneToManyMapping;
import oracle.toplink.eis.mappings.EISOneToOneMapping;
import oracle.toplink.eis.mappings.EISTransformationMapping;
...
import oracle.toplink.internal.expressions.ExpressionOperatorConverter;
...
import oracle.toplink.internal.identitymaps.NoIdentityMap;
import oracle.toplink.internal.identitymaps.SoftCacheWeakIdentityMap;
import oracle.toplink.internal.identitymaps.WeakIdentityMap;
...
import oracle.toplink.mappings.PropertyAssociation;
...
import oracle.toplink.mappings.transformers.ConstantTransformer;
import oracle.toplink.objectrelational.ArrayMapping;
import oracle.toplink.objectrelational.NestedTableMapping;
import oracle.toplink.objectrelational.ObjectArrayMapping;
import oracle.toplink.objectrelational.ObjectRelationalDescriptor;
import oracle.toplink.objectrelational.ReferenceMapping;
import oracle.toplink.objectrelational.StructureMapping;
...
import oracle.toplink.ox.jaxb.JAXBTypesafeEnumConverter;
...
import oracle.toplink.ox.mappings.XMLTransformationMapping;
import oracle.toplink.ox.schema.XMLSchemaClassPathReference;
import oracle.toplink.ox.schema.XMLSchemaFileReference;
...
import oracle.toplink.querykeys.OneToManyQueryKey;
import oracle.toplink.querykeys.OneToOneQueryKey;
...
import oracle.toplink.xdb.DirectToXMLTypeMapping;
...
public class ObjectPersistenceRuntimeXMLProject extends Project {
    ...
    protected ClassDescriptor buildAggregateCollectionMappingDescriptor() {
        ...
        sourceToTargetKeyFieldAssociationsMapping.setAttributeAccessor(new AttributeAccessor() {
                ...
                public void setAttributeValueInObject(Object object, Object value) {
                    ...
                    mapping.setSourceKeyFields(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(associations.size()));
                    mapping.setTargetForeignKeyFields(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(associations.size()));
    ...
    protected ClassDescriptor buildArrayMappingDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.objectrelational.ArrayMapping.class);
    ...
    protected ClassDescriptor buildBasicIndirectionPolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.indirection.BasicIndirectionPolicy.class);

        descriptor.getInheritancePolicy().setParentClass(oracle.toplink.internal.indirection.IndirectionPolicy.class);
    ...
    protected ClassDescriptor buildCollectionContainerPolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.queryframework.CollectionContainerPolicy.class);

        descriptor.getInheritancePolicy().setParentClass(oracle.toplink.internal.queryframework.InterfaceContainerPolicy.class);
    ...
    protected ClassDescriptor buildContainerIndirectionPolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.indirection.ContainerIndirectionPolicy.class);
    ...
    protected ClassDescriptor buildContainerPolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.queryframework.ContainerPolicy.class);
    ...
    public ClassDescriptor buildDatasourceLoginDescriptor() {
        ...
        descriptor.getInheritancePolicy().addClassIndicator(oracle.toplink.ox.XMLLogin.class, "toplink:xml-login");
        ...
        platformMapping.setConverter(new Converter(){
            ...
            public void initialize(DatabaseMapping mapping, Session session){
                ...
                this.platformList.put("oracle.toplink.internal.databaseaccess.AccessPlatform", "oracle.toplink.platform.database.AccessPlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.AttunityPlatform", "oracle.toplink.platform.database.AttunityPlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.CloudscapePlatform", "oracle.toplink.platform.database.CloudscapePlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.DatabasePlatform", "oracle.toplink.platform.database.DatabasePlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.DB2MainframePlatform", "oracle.toplink.platform.database.DB2MainframePlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.DB2Platform", "oracle.toplink.platform.database.DB2Platform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.DBasePlatform", "oracle.toplink.platform.database.DBasePlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.HSQLPlatform", "oracle.toplink.platform.database.HSQLPlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.InformixPlatform", "oracle.toplink.platform.database.InformixPlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.OraclePlatform", "oracle.toplink.platform.database.oracle.OraclePlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.PointBasePlatform", "oracle.toplink.platform.database.PointBasePlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.SQLAnyWherePlatform", "oracle.toplink.platform.database.SQLAnyWherePlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.SQLServerPlatform", "oracle.toplink.platform.database.SQLServerPlatform");
                this.platformList.put("oracle.toplink.internal.databaseaccess.SybasePlatform", "oracle.toplink.platform.database.SybasePlatform");
                this.platformList.put("oracle.toplink.oraclespecific.Oracle8Platform", "oracle.toplink.platform.database.oracle.Oracle8Platform");
                this.platformList.put("oracle.toplink.oraclespecific.Oracle9Platform", "oracle.toplink.platform.database.oracle.Oracle9Platform");
    ...
    protected ClassDescriptor buildFunctionExpressionDescriptor() {
        ...
        operatorConverter.addConversionValue("upper", new ExpressionOperator(ExpressionOperator.ToUpperCase, oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(0)));
        operatorConverter.addConversionValue("lower", new ExpressionOperator(ExpressionOperator.ToLowerCase, oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(0)));
        // Aggregate functions
        ...
        childrenMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildDatabaseQueryDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.queryframework.DatabaseQuery.class);
        ...
        argumentsMapping.setAttributeAccessor(new AttributeAccessor() {
                ...
                public void setAttributeValueInObject(Object object, Object value) {
                    ...
                    Vector arguments = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(queryArguments.size());
                    Vector types = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(queryArguments.size());
                    Vector values = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(queryArguments.size());
        ...
        redirectorMapping.setReferenceClass(oracle.toplink.queryframework.MethodBaseQueryRedirector.class);
    ...
    protected ClassDescriptor buildCallDescriptor() {
        ...
        descriptor.getInheritancePolicy().addClassIndicator(EJBQLCall.class, "toplink:ejbql-call");
        return descriptor;
    }
    ...
    protected ClassDescriptor buildEJBQLCallDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(EJBQLCall.class);
        descriptor.descriptorIsAggregate();
        descriptor.getInheritancePolicy().setParentClass(Call.class);
    ...
    protected ClassDescriptor buildObjectLevelReadQueryDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.queryframework.ObjectLevelReadQuery.class);

        descriptor.getInheritancePolicy().setParentClass(oracle.toplink.queryframework.ReadQuery.class);
        ...
        joinedAttributeMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildReadObjectQueryDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.queryframework.ReadObjectQuery.class);
        descriptor.getInheritancePolicy().setParentClass(oracle.toplink.queryframework.ObjectLevelReadQuery.class);
    ...
    protected ClassDescriptor buildReadAllObjectQueryDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.queryframework.ReadAllQuery.class);
        ...
        batchReadMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
        ...
        orderByMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildDeleteObjectQueryDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.queryframework.DeleteObjectQuery.class);
        descriptor.getInheritancePolicy().setParentClass(DatabaseQuery.class);
    ...
    protected ClassDescriptor buildReportQueryDescriptor() {
        ...
        reportItemsMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
        ...
        groupByMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildReportItemDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.queryframework.ReportItem.class);
        ...
        attributeExpressionMapping.setReferenceClass(oracle.toplink.expressions.Expression.class);
    ...
    protected ClassDescriptor buildDatabaseMappingDescriptor() {
        ...
        descriptor.getInheritancePolicy().addClassIndicator(DirectToXMLTypeMapping.class, "toplink:direct-xml-type-mapping");
    ...
    protected ClassDescriptor buildClassDescriptorDescriptor() {
        ...
        descriptor.getInheritancePolicy().addClassIndicator(ObjectRelationalDescriptor.class, "toplink:object-relational-class-mapping-descriptor");
        ...
        inheritancePolicyMapping.setReferenceClass(oracle.toplink.descriptors.InheritancePolicy.class);
        ...
        eventManagerMapping.setReferenceClass(oracle.toplink.descriptors.DescriptorEventManager.class);
        ...
        queryManagerMapping.setReferenceClass(oracle.toplink.descriptors.DescriptorQueryManager.class);
        ...
        aggregateCollectionMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
        ...
        instantiationPolicyMapping.setReferenceClass(oracle.toplink.internal.descriptors.InstantiationPolicy.class);
        ...
        queryKeysMapping.setReferenceClass(oracle.toplink.querykeys.QueryKey.class);
    ...
    protected ClassDescriptor buildDirectCollectionMappingDescriptor() {
        ...
        sourceToReferenceKeyFieldAssociationsMapping.setAttributeAccessor(new AttributeAccessor() {
                ...
                public void setAttributeValueInObject(Object object, Object value) {
                    ...
                    List associations = (List)value;
                    mapping.setSourceKeyFields(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(associations.size()));
                    mapping.setReferenceKeyFields(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(associations.size()));
                    Iterator iterator = associations.iterator();
                    while (iterator.hasNext()) {
                        Association association = (Association)iterator.next();
                        mapping.getSourceKeyFields().add((DatabaseField)association.getValue());
    ...
    protected ClassDescriptor buildDirectMapContainerPolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.queryframework.DirectMapContainerPolicy.class);
    ...
    protected ClassDescriptor buildDirectQueryKeyDescriptor() {
        ...
        descriptor.setJavaClass(oracle.toplink.querykeys.DirectQueryKey.class);

        descriptor.getInheritancePolicy().setParentClass(oracle.toplink.querykeys.QueryKey.class);
    ...
    protected ClassDescriptor buildEventManagerDescriptor() {
        ...
        descriptor.setJavaClass(oracle.toplink.descriptors.DescriptorEventManager.class);
        descriptor.setDefaultRootElement("event-policy");

        descriptor.getInheritancePolicy().setClassIndicatorField(new XMLField("@xsi:type"));
        descriptor.getInheritancePolicy().addClassIndicator(oracle.toplink.descriptors.DescriptorEventManager.class, "toplink:event-policy");
    ...
    protected ClassDescriptor buildHistoryPolicyDescriptor() {
        ...
        historyTablesMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
        ...
        startFieldNamesMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
        ...
        endFieldNamesMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildIndirectionPolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.indirection.IndirectionPolicy.class);
    ...
    protected ClassDescriptor buildInheritancePolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.descriptors.InheritancePolicy.class);
        descriptor.setDefaultRootElement("inheritance-policy");

        descriptor.getInheritancePolicy().setClassIndicatorField(new XMLField("@xsi:type"));
        descriptor.getInheritancePolicy().addClassIndicator(oracle.toplink.descriptors.InheritancePolicy.class, "toplink:inheritance-policy");
    ...
    protected ClassDescriptor buildQNameInheritancePolicyDescriptor() {
        ...
        descriptor.getInheritancePolicy().setParentClass(oracle.toplink.descriptors.InheritancePolicy.class);
    ...
    protected ClassDescriptor buildInstantiationPolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.descriptors.InstantiationPolicy.class);
    ...
    protected ClassDescriptor buildInterfaceContainerPolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.queryframework.InterfaceContainerPolicy.class);

        descriptor.getInheritancePolicy().setParentClass(oracle.toplink.internal.queryframework.ContainerPolicy.class);
    ...
    protected ClassDescriptor buildListContainerPolicyDescriptor() {
        ...
        descriptor.setJavaClass(oracle.toplink.internal.queryframework.ListContainerPolicy.class);
    ...
    protected ClassDescriptor buildManyToManyMappingMappingDescriptor() {
        ...
        sourceToRelationKeyFieldAssociationsMapping.setAttributeAccessor(new AttributeAccessor() {
                ...
                public void setAttributeValueInObject(Object object, Object value) {
                    ...
                    List associations = (List)value;
                    mapping.setSourceKeyFields(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(associations.size()));
                    mapping.setSourceRelationKeyFields(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(associations.size()));
                    Iterator iterator = associations.iterator();
                    while (iterator.hasNext()) {
                        Association association = (Association)iterator.next();
                        mapping.getSourceKeyFields().add((DatabaseField)association.getValue());
        ...
        targetToRelationKeyFieldAssociationsMapping.setAttributeAccessor(new AttributeAccessor() {
                ...
                public void setAttributeValueInObject(Object object, Object value) {
                    ManyToManyMapping mapping = (ManyToManyMapping)object;
                    List associations = (List)value;
                    mapping.setTargetKeyFields(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(associations.size()));
                    mapping.setTargetRelationKeyFields(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(associations.size()));
                    Iterator iterator = associations.iterator();
                    while (iterator.hasNext()) {
                        Association association = (Association)iterator.next();
    ...
    protected ClassDescriptor buildMapContainerPolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.queryframework.MapContainerPolicy.class);
    ...
    protected ClassDescriptor buildNestedTableMappingDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.objectrelational.NestedTableMapping.class);
    ...
    protected ClassDescriptor buildObjectArrayMappingDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.objectrelational.ObjectArrayMapping.class);
    ...
    protected ClassDescriptor buildObjectRelationalDescriptorDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(ObjectRelationalDescriptor.class);
        ...
        orderedFieldsMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildOneToOneMappingDescriptor() {
        ...
        foreignKeyFieldNamesMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildFieldTransformationDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.descriptors.FieldTransformation.class);
    ...
    protected ClassDescriptor buildTransformerBasedFieldTransformationDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.descriptors.TransformerBasedFieldTransformation.class);
        descriptor.getInheritancePolicy().setParentClass(oracle.toplink.internal.descriptors.FieldTransformation.class);
    ...
    protected ClassDescriptor buildProjectDescriptor() {
        ...
        descriptorsMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildProxyIndirectionPolicyDescriptor() {
        ...
        descriptor.setJavaClass(oracle.toplink.internal.indirection.ProxyIndirectionPolicy.class);
    ...
    protected ClassDescriptor buildQueryKeyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.querykeys.QueryKey.class);
    ...
    protected ClassDescriptor buildQueryManagerDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.descriptors.DescriptorQueryManager.class);
        descriptor.setDefaultRootElement("query-policy");

        descriptor.getInheritancePolicy().setClassIndicatorField(new XMLField("@xsi:type"));
        descriptor.getInheritancePolicy().addClassIndicator(oracle.toplink.descriptors.DescriptorQueryManager.class, "toplink:query-policy");
    ...
    protected ClassDescriptor buildReturningPolicyDescriptor() {
        ...
        returningFieldInfoMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildStructureMappingDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.objectrelational.StructureMapping.class);
    ...
    protected ClassDescriptor buildTransparentIndirectionPolicyDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(oracle.toplink.internal.indirection.TransparentIndirectionPolicy.class);
    ...
    protected ClassDescriptor buildVariableOneToOneMappingDescriptor() {
        ...
        foreignKeyFieldsMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildSelectedFieldsLockingPolicyDescriptor() {
        ...
        fieldsMapping.useCollectionClass(oracle.toplink.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildXMLLoginDescriptor() {
        ...
        descriptor.setJavaClass(oracle.toplink.ox.XMLLogin.class);
        descriptor.getInheritancePolicy().setParentClass(DatasourceLogin.class);
