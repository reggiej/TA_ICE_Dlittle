...
import oracle.toplink.indirection.IndirectMap;
...
public class ProjectClassGenerator {
    ...
    protected void addDirectMapMappingLines(NonreflectiveMethodDefinition method, String mappingName, DirectMapMapping mapping) {
        method.addLine(mappingName + ".setDirectKeyFieldName(\"" + mapping.getDirectKeyField().getQualifiedName() + "\");");
    ...
    protected void addForeignReferenceMappingLines(NonreflectiveMethodDefinition method, String mappingName, ForeignReferenceMapping mapping) {
        ...
        if (mapping.isCollectionMapping()) {
            ...
            if (mapping.getContainerPolicy().isCollectionPolicy()) {
                ...
                String keyMethodName = ((oracle.toplink.internal.queryframework.MapContainerPolicy)collectionMapping.getContainerPolicy()).getKeyName();
                if (policy instanceof TransparentIndirectionPolicy) {
    ...
    protected void addMappingLines(NonreflectiveMethodDefinition method, DatabaseMapping mapping) {
        ...
        if (packageName.equals("oracle.toplink.mappings")) {
    ...
    protected void addOptimisticLockingLines(NonreflectiveMethodDefinition method, OptimisticLockingPolicy policy) {
        ...
        if (packageName.equals("oracle.toplink.descriptors")) {
    ...
    protected void addXMLInteractionLines(NonreflectiveMethodDefinition method, XMLInteraction interaction, String variableName) {
        method.addLine("oracle.toplink.eis.XMLInteraction " + variableName + " = new oracle.toplink.eis.XMLInteraction();");
    ...
    protected ClassDefinition generateProjectClass() {
        ...
        classDefinition.addImport("oracle.toplink.mappings.converters.*");
        ...
        classDefinition.addImport("oracle.toplink.sequencing.*");

        classDefinition.setComment("This class was generated by the TopLink project class generator." + Helper.cr() + "It stores the meta-data (descriptors) that define the TopLink mappings." + Helper.cr() + "## " + DatabaseLogin.getVersion() + " ##" + Helper.cr() + "@see oracle.toplink.tools.workbench.ProjectClassGenerator");
