...
public class SessionManager {
    ...
    * getSession by name API.
     ...
     * INTERNAL:
     */
    public synchronized TopLinkSessions getInternalMWConfigObjects(String resourceName, ClassLoader objectClassLoader) {
     ...
     * INTERNAL:
     */
    public synchronized TopLinkSessions getInternalMWConfigObjects(String resourceName, ClassLoader objectClassLoader, boolean validate) {
     ...
     */
    public oracle.toplink.internal.sessions.AbstractSession getSession(String sessionName) {
     ...
     */
    public oracle.toplink.internal.sessions.AbstractSession getSession(String sessionName, boolean shouldLoginSession) {
        XMLSessionConfigLoader loader = new XMLSessionConfigLoader();
        loader.setSessionName(sessionName);
     ...
     */
    public oracle.toplink.internal.sessions.AbstractSession getSession(String sessionName, boolean shouldLoginSession, boolean shouldRefreshSession) {
        XMLSessionConfigLoader loader = new XMLSessionConfigLoader();
        loader.setSessionName(sessionName);
        loader.setShouldLogin(shouldLoginSession);
     ...
     * will be refreshed.
     */
    public oracle.toplink.internal.sessions.AbstractSession getSession(String sessionName, Object objectBean) {
        XMLSessionConfigLoader loader = new XMLSessionConfigLoader();
        loader.setSessionName(sessionName);
     ...
     * Login the session.
     */
    public oracle.toplink.internal.sessions.AbstractSession getSession(String sessionName, String filename) {
        XMLSessionConfigLoader loader = new XMLSessionConfigLoader();
        loader.setSessionName(sessionName);
     ...
     */
    public synchronized oracle.toplink.internal.sessions.AbstractSession getWASSession(WASXMLSessionConfigLoader xmlSessionConfigLoader, ClassLoader classLoader) {
        oracle.toplink.internal.sessions.AbstractSession aSession = null;
    ...
    * file in a TopLink directory on your classpath.
    ...
    public void setDefaultSession(Session defaultSession) {
        this.defaultSession = (oracle.toplink.internal.sessions.AbstractSession)defaultSession;
