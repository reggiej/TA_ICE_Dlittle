...
public abstract class Expression implements Serializable, Cloneable {
    ...
    public Expression appendSQL(String sqlString) {
        ...
        Vector v = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(1);
     ...
     * <p>
     * <pre>
     *  TopLink: employee.asOf(new AsOfClause(pastTime))
     *  Java: None
     ...
     * TopLink will even automatically interpret x.get("this") for you so you do
    ...
    public Expression between(Object leftValue, Object rightValue) {
        ...
        Vector args = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance();
    ...
    public Expression caseStatement(Map caseItems, String defaultItem) {
        ...
        Vector v = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(caseItems.size() + 1);
        v.addElement("CASE ");
     ...
     * @see oracle.toplink.mappings.ForeignReferenceMapping#batchedValueFromRow
   ...
   public Expression currentTime() {
    ...
    public Expression decode(Map decodeableItems, String defaultItem) {
        ...
        Vector v = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(decodeableItems.size() + 1);
        v.addElement("DECODE(");
     ...
     * @see #asOf(oracle.toplink.history.AsOfClause)
     * @see #hasAsOfClause()
     */
    ...
    public Vector getFields() {
        return oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(1);
    }
    ...
    public Expression getFunctionWithArguments(String functionName, Vector arguments) {
        ExpressionOperator anOperator = new ExpressionOperator();
        anOperator.setType(ExpressionOperator.FunctionOperator);
        Vector v = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(arguments.size());
    ...
    public Expression in(byte[] theBytes) {
        Vector vector = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance();
    ...
    public Expression in(boolean[] theBooleans) {
        ...
        for (int index = 0; index < theBooleans.length; index++) {
            vector.addElement(Boolean.valueOf(theBooleans[index]));
        }
    ...
    public Expression leftPad(Object size, Object substring) {
        ...
        Vector args = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(2);
    ...
    public Expression locate(Object str) {
        ...
        Vector args = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(1);
        args.addElement(str);
        return anOperator.expressionForArguments(this, args);
    }
     ...
     * @param String xpath - XPath expression representing the node to be returned
     */
    ...
    protected void writeField(ExpressionSQLPrinter printer, DatabaseField field, SQLSelectStatement statement) {
        ...
        if (statement.getUseUniqueFieldAliases()){
            printer.printString(" AS " + field.getName() + statement.getNextFieldCounterValue() );
        }
    }
