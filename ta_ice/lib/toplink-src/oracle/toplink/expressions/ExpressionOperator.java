...
public class ExpressionOperator implements Serializable {
    ...
    public static ExpressionOperator oracleDateName() {
        ...
        Vector v = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(3);
    ...
    public Expression expressionFor(Expression base) {
        return expressionForArguments(base, oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(0));
    }
     ...
     * <p>Node classes given belong to oracle.toplink.internal.expressions.
     */
    ...
    public static ExpressionOperator simpleThreeArgumentFunction(int selector, String dbString) {
        ...
        exOperator.setType(FunctionOperator);
        exOperator.setSelector(selector);
        Vector v = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(4);
    ...
    public static ExpressionOperator simpleTwoArgumentFunction(int selector, String dbString) {
        ...
        exOperator.setType(FunctionOperator);
        exOperator.setSelector(selector);
        Vector v = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(5);
        v.addElement(dbString + "(");
        v.addElement(", ");
        v.addElement(")");
        exOperator.printsAs(v);
