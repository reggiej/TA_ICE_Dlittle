 ...
 * @see oracle.toplink.expressions.Expression#asOf(AsOfClause)
 * @see oracle.toplink.queryframework.ObjectLevelReadQuery#asOf(AsOfClause)
 * @see oracle.toplink.sessions.Session#acquireSessionAsOf(AsOfClause)
 * @see HistoryPolicy
 */
