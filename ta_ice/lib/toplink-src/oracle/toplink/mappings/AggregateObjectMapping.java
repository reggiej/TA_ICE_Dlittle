...
public class AggregateObjectMapping extends AggregateMapping implements RelationalMapping {
     ...
     */
    protected Object buildAggregateFromRow(AbstractRecord databaseRow, Object targetObject, JoinedAttributeManager joinManager, ObjectBuildingQuery sourceQuery, boolean buildShallowOriginal, AbstractSession executionSession) throws DatabaseException {
        // check for all NULLs
    ...
    public void initializeParentInheritance(ClassDescriptor parentDescriptor, ClassDescriptor childDescriptor, AbstractSession session) throws DescriptorException {
        ...
        Vector children = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(1);
