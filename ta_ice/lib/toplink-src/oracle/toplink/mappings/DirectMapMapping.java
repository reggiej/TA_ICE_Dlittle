        ...
        if (keyConverterClassName != null) {
            ...
            try {
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    keyConverterClass = oracle.toplink.internal.security.PrivilegedAccessHelper.getClassForName(keyConverterClassName, true, classLoader);
                    keyConverter = (Converter) oracle.toplink.internal.security.PrivilegedAccessHelper.newInstanceFromClass(keyConverterClass);
                }
