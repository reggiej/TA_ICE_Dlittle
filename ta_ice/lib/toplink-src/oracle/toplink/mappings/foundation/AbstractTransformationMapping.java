...
import oracle.toplink.mappings.transformers.*;
...
public abstract class AbstractTransformationMapping extends DatabaseMapping {
    ...
    public AbstractTransformationMapping() {
        fieldTransformations = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance();
        fieldToTransformers = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance();
        setIsMutable(true);
        dontUseIndirection();
    }
     ...
     * <code>oracle.toplink.sessions.Session</code>.
     */
    ...
    public Object clone() {
        ...
        clone.setFieldToTransformers(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(getFieldToTransformers().size() + 1));
    ...
    */
    ...
    public void setFieldNameToMethodNameAssociations(Vector associations) {
        setFieldTransformations(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(associations.size()));
     ...
     * This defaults to false and only required for transformations that perform database access.
     * @see oracle.toplink.mappings.IndirectionPolicy
     */
