        ...
        if (converterClassName != null) {
            ...
            try {
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    converterClass = oracle.toplink.internal.security.PrivilegedAccessHelper.getClassForName(converterClassName, true, classLoader);
                    converter = (Converter) oracle.toplink.internal.security.PrivilegedAccessHelper.newInstanceFromClass(converterClass);
                }
