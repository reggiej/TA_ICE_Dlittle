...
public class DirectCollectionMapping extends CollectionMapping implements RelationalMapping {
    ...
    public DirectCollectionMapping() {
        ...
        this.referenceKeyFields = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(1);
        ...
        if (valueConverterClassName != null) {
            ...
            try {
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    valueConverterClass = oracle.toplink.internal.security.PrivilegedAccessHelper.getClassForName(valueConverterClassName, true, classLoader);
                    valueConverter = (Converter) oracle.toplink.internal.security.PrivilegedAccessHelper.newInstanceFromClass(valueConverterClass);
                }
     ...
     * @see oracle.toplink.mappings.DirectMapMapping
     */
