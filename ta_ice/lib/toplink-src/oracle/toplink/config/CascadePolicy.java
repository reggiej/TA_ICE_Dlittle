 ...
 * 
 * The class contains all the valid values for TopLinkQueryHints.REFRESH_CASCADE query hint.
 * 
 * JPA Query Hint Usage:
 * 
 * query.setHint(TopLinkQueryHints.REFRESH_CASCADE, CascadePolicy.CascadeAllParts);
 * or 
 * @QueryHint(name=TopLinkQueryHints.REFRESH_CASCADE, value=CascadePolicy.CascadeAllParts)
 * 
