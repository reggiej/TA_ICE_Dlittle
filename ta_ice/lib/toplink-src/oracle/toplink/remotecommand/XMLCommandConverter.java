 ...
 * <p>
 * <b>Purpose</b>:
 * <p> This is TopLink Command converter class that impelments the public API oracle.toplink.remotecommand.CommandConverter
 * <b>Description</b>:
 * <p> The converter provides the conversion between TopLink proprietary cache synchronization command,
 *  oracle.toplink.remotecommand.MergeChangeSetCommand and XML org.w3c.dom.Document.  When this
 *  command converter is plugged into oracle.toplink.remotecommand.CommandManager, it enables third party
 ...
 * @see oracle.toplink.remotecommand.CommandManager
...
public class XMLCommandConverter implements CommandConverter {
    ...
    /**
     * PUBLIC:
     * Convert input command to oracle.toplink.remotecommand.MergeChangeSetCommand object and throw exception if it cannot convert.
     ...
     * @param command must be of type oracle.toplink.remotecommand.MergeChangeSetCommand
     * @exception java.lang.RuntimeException if there is error during the conversion or the command parameter is not the expected type
    ...
    protected XMLParser getNonValidatingDomParser() {
        if(nonValidatingParser == null) {
            ...
            nonValidatingParser.setErrorHandler(new TopLinkXMLErrorHanlder());
        }
    ...
    protected XMLParser getValidatingDomParser() {
        if(validatingParser == null) {
            ...
            validatingParser.setErrorHandler(new TopLinkXMLErrorHanlder());
     ...
     * @author Steven Vo
     */
    class TopLinkXMLErrorHanlder implements org.xml.sax.ErrorHandler {
