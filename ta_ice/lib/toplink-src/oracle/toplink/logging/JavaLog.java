...
import oracle.toplink.internal.localization.i18n.*;
...
public class JavaLog extends AbstractSessionLog {
     ...
     */
    public static final String TOPLINK_NAMESPACE = "oracle.toplink";
    ...
    /**
     * Stores the namespace for session, i.e."oracle.toplink.session.<sessionname>".
     */
    private String sessionNameSpace;

    /**
     * Stores the Logger for session namespace, i.e. "oracle.toplink.session.<sessionname>".
     */
    ...
    public void setWriter(OutputStream fileOutputStream){
        StreamHandler sh = new StreamHandler(fileOutputStream,new TopLinkSimpleFormatter());
