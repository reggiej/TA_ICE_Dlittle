 ...
 */
class SDKOrderedCollectionChangeRecord extends CollectionChangeRecord implements oracle.toplink.changesets.SDKOrderedCollectionChangeRecord {
     ...
     */
    SDKOrderedCollectionChangeRecord(ObjectChangeSet owner, String attributeName, DatabaseMapping mapping) {
        super();
        this.owner = owner;
     ...
     */
    void addAddedChangeSet(Object changeSet, int index) {
     ...
     */
    void addMovedChangeSet(Object changeSet, int oldIndex, int newIndex) {
     ...
     */
    void addRemovedChangeSet(Object changeSet, int index) {
    ...
    private int getBeforeMoveIndex(int index) {
        return this.getMoveIndexes()[index][0];
    }

    /**
     * Return the specified "after" move index.
     */
    private int getAfterMoveIndex(int index) {
        return this.getMoveIndexes()[index][1];
    }
    ...
    /**
     * Return the specified remove.
     */
    private Object getRemove(int index) {
        return this.getRemoves().get(index);
    }
    ...
    /**
     * Return the number of removes, without triggering
     * the instantiation of the collection.
     */
    private int getRemovesSize() {
        if (removes == null) {
            return 0;
        }
        return removes.size();
