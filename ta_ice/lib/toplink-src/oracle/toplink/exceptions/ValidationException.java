...
import oracle.toplink.mappings.DatabaseMapping;// 78aclt
...
public class ValidationException extends TopLinkException {
    ...
    //EJB30
    // The following constants need to be removed along with their exception methods - a large verification task
    ...
    */
    ...
    public static ValidationException illegalUseOfMapInDirectCollection(oracle.toplink.mappings.DirectCollectionMapping directCollectionMapping, Class aMapClass, String keyMethodName) {
    ...
    public static ValidationException invalidConnector(oracle.toplink.sessions.Connector connector) {
    ...
    */
    ...
    public static ValidationException noTablesToCreate(oracle.toplink.sessions.Project project) {
        Object[] args = { project };
