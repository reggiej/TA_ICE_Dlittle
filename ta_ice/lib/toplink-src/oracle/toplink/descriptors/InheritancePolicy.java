...
public class InheritancePolicy implements Serializable, Cloneable {
    ...
    public InheritancePolicy() {
        ...
        this.allChildClassIndicators = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance();
        this.childDescriptors = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(5);
    ...
    public SQLSelectStatement buildViewSelectStatement(ObjectLevelReadQuery query) {
        ...
        selectStatement.setTables(oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(1));
    ...
    public void convertClassNamesToClasses(ClassLoader classLoader) {
        ...
        while (keysEnum.hasNext()) {
            ...
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    theClass = oracle.toplink.internal.security.PrivilegedAccessHelper.getClassForName((String)key, true, classLoader);
                }
        ...
        try{
            if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                ...
                parentClass = oracle.toplink.internal.security.PrivilegedAccessHelper.getClassForName(getParentClassName(), true, classLoader);
            }
        } catch (ClassNotFoundException exc){
