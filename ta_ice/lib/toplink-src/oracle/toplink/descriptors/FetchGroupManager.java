 ...
 * <p>
 * The domain object must implement oracle.toplink.queryframework.FetchGroupTracker interface,
...
public class FetchGroupManager implements Cloneable {
     ...
     *
     * @see oracle.toplink.queryframework.ObjectLevelReadQuery#setShouldUseDefaultFetchGroup(boolean)
     */
