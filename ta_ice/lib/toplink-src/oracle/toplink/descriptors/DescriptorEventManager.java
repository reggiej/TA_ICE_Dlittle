...
public class DescriptorEventManager implements Cloneable, Serializable {
   ...
   protected static final int NumberOfEvents = 18;
    ...
    public DescriptorEventManager() {
        this.eventSelectors = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(NumberOfEvents);
        this.eventMethods = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(NumberOfEvents);
...
/*    public Vector getDefaultEventListeners() {
    ...
    public Vector getEventListeners() {
        ...
        if (eventListeners == null) {
            eventListeners = oracle.toplink.internal.helper.NonSynchronizedVector.newInstance(1);
        }
