...
import oracle.toplink.internal.descriptors.changetracking.*;
        ...
        if (!isNew) {
            ...
            if (changes != null) {
                ...
                if (changes.getUOWChangeSet() != changeSet) {
                    changes = changeSet.mergeObjectChanges(changes, (oracle.toplink.internal.sessions.UnitOfWorkChangeSet)changes.getUOWChangeSet());
                }
