...
public class DeferredChangeDetectionPolicy implements ObjectChangePolicy, java.io.Serializable {
     ...
     */
    public ObjectChangeSet calculateChanges(Object clone, Object backUp, oracle.toplink.internal.sessions.UnitOfWorkChangeSet changeSet, AbstractSession session, ClassDescriptor descriptor, boolean shouldRaiseEvent) {
     ...
     */
    public ObjectChangeSet createObjectChangeSet(Object clone, Object backUp, oracle.toplink.internal.sessions.UnitOfWorkChangeSet changeSet, boolean isNew, AbstractSession session, ClassDescriptor descriptor) {
