...
/**
 * INTERNAL:
* oracle/toplink/internal/remote/TransporterHelper.java
...
abstract public class TransporterHelper {
    private static String _id = "IDL:oracle/toplink/internal/remote/Transporter:1.0";

    public static void insert(org.omg.CORBA.Any a, oracle.toplink.internal.remote.Transporter that) {
    ...
    public static oracle.toplink.internal.remote.Transporter extract(org.omg.CORBA.Any a) {
    ...
    public static oracle.toplink.internal.remote.Transporter read(org.omg.CORBA.portable.InputStream istream) {
        oracle.toplink.internal.remote.Transporter value = new oracle.toplink.internal.remote.Transporter();
        ...
        IdentityHashtable descriptors = null;
        ...
        try {
            ...
            descriptors = (IdentityHashtable)objectIn.readObject();
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream, oracle.toplink.internal.remote.Transporter value) {
