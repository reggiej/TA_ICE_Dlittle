 ...
 *         {@link oracle.toplink.remotecommand.corba.sun.SunCORBATransportManager}
 */
public class CORBAJNDIClusteringService extends oracle.toplink.remote.AbstractJNDIClusteringService {
    private static Class DEFAULT_DISPATCHER_CLASS = oracle.toplink.remote.corba.sun.CORBARemoteSessionControllerDispatcher.class;
    private static Class DEFAULT_CONNECTION_CLASS = oracle.toplink.remote.corba.sun.CORBAConnection.class;
    ...
    public void connectBackToRemote(RemoteConnection connection) throws Exception {
        oracle.toplink.internal.remote.ConnectToJNDISessionCommand command = new oracle.toplink.internal.remote.ConnectToJNDISessionCommand();
