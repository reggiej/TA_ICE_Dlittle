...
public class _RMIRemoteSessionController_Stub extends Stub implements RMIRemoteSessionController {
     ...
     * @return oracle.toplink.internal.remote.Transporter
     * @param stream org.omg.CORBA_2_3.portable.InputStream
     */
    public static oracle.toplink.internal.remote.Transporter readTransporter(org.omg.CORBA.portable.InputStream stream) {
        ...
        oracle.toplink.internal.remote.Transporter transporter = null;
        if (bytes.length == 0) {
            return null;
        }
        try {
            java.io.ObjectInputStream objectIn = new java.io.ObjectInputStream(byteIn);
            transporter = (oracle.toplink.internal.remote.Transporter)objectIn.readObject();
     ...
     * @param transporter oracle.toplink.internal.remote.Transporter
     */
    public static void writeTransporter(oracle.toplink.internal.remote.Transporter transporter, org.omg.CORBA.portable.OutputStream stream) {
