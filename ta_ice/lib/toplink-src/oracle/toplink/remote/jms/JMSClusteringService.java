 ...
 */
public class JMSClusteringService extends oracle.toplink.remote.AbstractJNDIClusteringService {
    ...
    public void connectBackToRemote(RemoteConnection connection) throws Exception {
        ...
        TopLinkMessageListener listener = new TopLinkMessageListener(getSession());
    ...
    public void stopListening() {
        ...
        try {
            ...
            ((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.WARNING, SessionLog.PROPAGATION, "exception_thrown_when_attempting_to_close_listening_topic_connection", exception);
        }
    }
}