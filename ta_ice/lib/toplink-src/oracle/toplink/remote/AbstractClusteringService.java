...
/**
    ...
    */
    ...
    public void run()
    {
    	...
    	((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.FINEST, SessionLog.PROPAGATION, "connecting_to_other_sessions");
    	...
    	((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.FINEST, SessionLog.PROPAGATION, "done");
    	listen();     
     }
	...
	*/
	public void announceSession(String sessionIdentifier) {
		...
		((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.FINER, SessionLog.PROPAGATION, "announcement_sent_from", getSessionId());
	}
	...
	public void listen() {
		...
		while (! stopListening) {
			...
			try {
				...
				((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.WARNING, SessionLog.PROPAGATION, "corrupted_session_announcement", getSessionId());
				continue;
			}
	...
	public void receivedAnnouncement(String sessionId, String jndiHostURL, String applicationName){
		((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.FINER, SessionLog.PROPAGATION, "announcement_received_from", sessionId);
