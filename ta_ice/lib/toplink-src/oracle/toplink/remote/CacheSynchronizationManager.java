...
public class CacheSynchronizationManager {
    ...
    public void addRemoteConnection(RemoteConnection connection) {
        ...
        try {
            ...
            ((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.FINEST, SessionLog.PROPAGATION, "received_connection_from", connection.getServiceName());
            ...
            try {
                ...
                ((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.WARNING, SessionLog.PROPAGATION, "problem_adding_remote_connection", reThrownException);
    ...
    public void propagateChanges(UnitOfWorkChangeSet changeSet) {
        ...
        ((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.FINEST, SessionLog.PROPAGATION, "sending_changeset_to_network");
        ...
        while (distributedSessions.hasMoreElements()) {
            ...
            try {
                ...
                try {
                    ...
                    ((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.FINER, SessionLog.PROPAGATION, "failed_to_reconnect_remote_connection");
                    try {
                    ...
                    if (shouldRemoveConnectionOnError()) {
                        ...
                        ((oracle.toplink.internal.sessions.AbstractSession)getSession()).log(SessionLog.FINER, SessionLog.PROPAGATION, "dropping_connection", connection.getServiceName());
                    }
                    try {
