 ...
 */
public class ICEfacesIDDisposedEvent
extends AbstractSessionEvent
implements ContextEvent {
    /**
     * Constructs an <code>ICEfacesIDDisposedEvent</code> with the specified
     * <code>source</code> and <code>iceFacesId</code>. </p>
     *
     * @param source
     * @param iceFacesId the ICEfaces ID that has been disposed.
